...
# ==============================================================================
# APLIKASI STREAMLIT - ENHANCED VERSION (Compatible with existing functions)
# ==============================================================================
def main():
    st.set_page_config(
    ...
    if page == "🏠 Home":
        ...
        try:
            ...
            # Show summary stats - FIXED: check if data exists
            ...
            with col3:
                create_metric_card("Features Matched", "Calculating...", icon="⏳")
            
            with col4:
                create_metric_card("Match Rate", "Calculating...", icon="🎯")
        ...
        with col3:
            match_rate = (num_matched / len(feature_names) * 100) if len(feature_names) > 0 else 0
        ...
        if not is_valid:
            ...
            Dataset Anda hanya memiliki {num_matched} features yang cocok, minimal {MIN_FEATURES} features diperlukan.
        ...
        try:
            ...
            # FIXED: Check if there are matched importances before normalizing
            if len(matched_importances) > 0:
                matched_importances = matched_importances / matched_importances.sum()
            else:
                st.error("❌ Tidak ada feature importance yang bisa dihitung.")
                st.stop()
        ...
        try:
            ...
            st.session_state.decision_matrix = decision_matrix
